...
import { Col, Collapse, DropdownItem, DropdownMenu, DropdownToggle, Form, Input, InputGroup, InputGroupText, Media, Nav, NavItem, NavLink, Navbar, NavbarBrand, Row, UncontrolledDropdown } from "reactstrap"
...
export const SiderBar = props => {
    ...
    return(
        <Navbar className="navbar-vertical fixed-left navbar-light bg-white" expand="md" id="sidebar-main">
            {/* Toggler */}
